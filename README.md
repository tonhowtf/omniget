...
As a downloader it is a udemy downloader, hotmart downloader and course downloader for
...
- [Notice to platform owners](#notice-to-platform-owners)
...
- **MCP both ways.** External MCP servers become tools, granted per agent as *auto*, *ask* or *deny*. And OmniGet serves its own 56 tools, the coding ones included, to Claude Code, Cursor, VS Code and the rest: see [OmniGet for AI agents](#omniget-for-ai-agents-mcp-server-and-claude-code-plugin).
...
### Udemy downloader and Hotmart downloader, plus Rocketseat

OmniGet downloads the courses you bought on Udemy, Hotmart, Rocketseat and Meta-Analysis Academy. Sign in inside the app, tick the sections you want, and every lesson and attachment lands in a folder per course, numbered in order, resuming where it stopped. The course then opens in the built-in player with timestamped notes. Details in [Courses](#courses).
...
|---|---|
| Online courses | Hotmart, Udemy, Rocketseat and Meta-Analysis Academy through the Courses plugin. Every lesson, section selection, attachments, resume where you stopped. |
...
Yes. The Courses plugin comes preinstalled: sign in through the app, pick the course and its sections, and download. Lessons and attachments land in a folder per course and appear in Study. Rocketseat and Meta-Analysis Academy work the same way.
...
If you own a platform and want OmniGet to stop supporting it, email **tonhowtf@gmail.com** from a company address. The site comes out of the documentation and the code this project maintains, and its domains go on an opt-out list that the app enforces. The process and the current list are in [PLATFORM-OWNERS.md](PLATFORM-OWNERS.md).

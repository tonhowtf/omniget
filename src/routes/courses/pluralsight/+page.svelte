<script lang="ts">
  ...
  let courses: PluralsightCourse[] = $state([]);
  ...
  async function downloadCourse(course: PluralsightCourse) {
...
{:else if loggedIn}
  <div class="page-logged">
    <div class="session-bar">
      <span class="session-info">Pluralsight</span>

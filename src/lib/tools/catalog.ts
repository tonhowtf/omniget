...
export const TOOLS: ToolEntry[] = [
  ...
  { id: "ai-mcp", category: "ai", icon: "glyph:plug", ...P.purple, platforms: ALL_OS, status: "beta", runner: "mcp", href: "/llm/mcp", keywords: ["mcp", "agente", "agent", "claude", "goose", "cursor", "servidor mcp", "automatizar", "tools"] },
